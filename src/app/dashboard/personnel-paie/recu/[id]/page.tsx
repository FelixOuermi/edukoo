...
export default async function PayrollRecuPage({
  params,
}: {
  ...
  const staffMember = (payment.staff_members as unknown as { name: string } | null)
    ...
    <div className="max-w-lg mx-auto text-center space-y-6 py-10">
      ...
      <div>
        ...
        <p className="text-gray-500 mt-2">
          {staffMember?.name ?? '—'} — {t.receiptLabel}{' '}
      ...
      <div className="flex flex-col sm:flex-row gap-3 justify-center">
        <a
          href={`/dashboard/personnel-paie/recu/${payment.id}/pdf`}
          target="_blank"
